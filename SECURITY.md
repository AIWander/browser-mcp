...
If you discover a security vulnerability in browser-mcp, please report it privately
via GitHub's Private Vulnerability Reporting:

1. Go to https://github.com/AIWander/browser-mcp/security
...
browser-mcp is under active development. Only the latest release receives security
fixes. Older releases are not supported.

## Scope

In scope:
- The browser-mcp binary/library and any bundled assets
